...
#        echo '<pre>';var_dump($_REQUEST);die;
    ...
    public function delete_action($id)
    {
        ...
        PageLayout::postSuccess(_('Die Umfrage wurde erfolgreich gelöscht.'));
        $this->redirect('admin');
    }
    ...
    public function mail_action($id)
    {
        ...
        if (empty($mail_to)) {
            PageLayout::postError(_('Sie haben keine Empfänger ausgewählt.'));
        ...
        if (empty($mail_to)) {
            PageLayout::postError(_('Es wurden keine gültigen Empfänger gefunden.'));
            $this->redirect('admin/edit/' . $id);
            return;
        }
